...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/breaker_exempt", permission: authz.ChannelRead, handler: controller.GetChannelBreakerExemptChannels},
	...
	{method: http.MethodGet, path: "/economics", permission: authz.ChannelRead, handler: controller.GetChannelEconomics},
