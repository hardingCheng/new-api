...
func InitOptionMap() {
	...
	common.OptionMap["StationConfigs"] = setting.StationConfigs2JsonString()
	...
	common.OptionMap["ChannelBreakerFailureStatusCodes"] = operation_setting.ChannelBreakerFailureStatusCodesToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "StationConfigs":
		err = setting.UpdateStationConfigsByJsonString(value)
	case "AutoGroups":
	...
	case "ModelQuotaPool":
		err = ratio_setting.UpdateModelQuotaPoolByJSONString(value)
	...
	case "ChannelBreakerFailureStatusCodes":
		err = operation_setting.ChannelBreakerFailureStatusCodesFromString(value)
